...
export function enrichRisikomanagement(
  risikomanagement: Risikomanagement[],
  maps: RisikomanagementMaps
): EnrichedRisikomanagement[] {
  return risikomanagement.map(r => ({
    ...r,
...
export function enrichAufgabenFreigaben(
  ...
  return aufgabenFreigaben.map(r => ({
    ...r,
    task_related_riskName: resolveDisplay(r.fields.task_related_risk, maps.risikomanagementMap, 'risk_title'),
...
export function enrichMassnahmenManagement(
  ...
  return massnahmenManagement.map(r => ({
    ...r,
    measure_riskName: resolveDisplay(r.fields.measure_risk, maps.risikomanagementMap, 'risk_title'),
  }));
}
