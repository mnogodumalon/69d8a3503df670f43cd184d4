...
import type { Organisationseinheiten, AssetRegister, FrameworkVerwaltung, RisikoRegister, MassnahmenManagement, KontrollManagement, SoaManagement, AuditManagement, FindingsAbweichungen, IncidentManagement, Lieferantenmanagement, PolicyManagement, DokumenteEvidenzen, BcmNotfallmanagement, AwarenessSchulungen, AufgabenFreigaben, CreateOrganisationseinheiten, CreateAssetRegister, CreateFrameworkVerwaltung, CreateRisikoRegister, CreateMassnahmenManagement, CreateKontrollManagement, CreateSoaManagement, CreateAuditManagement, CreateFindingsAbweichungen, CreateIncidentManagement, CreateLieferantenmanagement, CreatePolicyManagement, CreateDokumenteEvidenzen, CreateBcmNotfallmanagement, CreateAwarenessSchulungen, CreateAufgabenFreigaben } from '@/types/app';
