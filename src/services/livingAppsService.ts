...
import type { BcmNotfallmanagement, Lieferantenmanagement, PolicyManagement, FrameworkVerwaltung, IncidentManagement, SoaManagement, Risikomanagement, DokumenteEvidenzen, Organisationseinheiten, AufgabenFreigaben, MassnahmenManagement, FindingsAbweichungen, AuditManagement, AssetRegister, KontrollManagement, AwarenessSchulungen, CreateBcmNotfallmanagement, CreateLieferantenmanagement, CreatePolicyManagement, CreateFrameworkVerwaltung, CreateIncidentManagement, CreateSoaManagement, CreateRisikomanagement, CreateDokumenteEvidenzen, CreateOrganisationseinheiten, CreateAufgabenFreigaben, CreateMassnahmenManagement, CreateFindingsAbweichungen, CreateAuditManagement, CreateAssetRegister, CreateKontrollManagement, CreateAwarenessSchulungen } from '@/types/app';
