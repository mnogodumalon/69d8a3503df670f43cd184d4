...
export interface Risikomanagement {
  record_id: string;
  createdat: string;
  updatedat: string | null;
  fields: {
...
export interface AufgabenFreigaben {
  ...
  fields: {
    ...
    task_related_risk?: string; // applookup -> URL zu 'Risikomanagement' Record
...
export interface MassnahmenManagement {
  ...
  fields: {
    ...
    measure_risk?: string; // applookup -> URL zu 'Risikomanagement' Record
...
export const APP_IDS = {
  ...
  RISIKOMANAGEMENT: '69d8a2cdd093755ffa3afc64',
...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  ...
  'soa_management': {
    soa_inclusion_reason: [{ key: "gesetzlich", label: "Gesetzliche Anforderung" }, { key: "vertraglich", label: "Vertragliche Anforderung" }, { key: "risiko", label: "Ergebnis der Risikobeurteilung" }, { key: "best_practice", label: "Best Practice" }, { key: "richtlinie", label: "Unternehmensrichtlinie" }],
  ...
  'risikomanagement': {
    ...
    risk_confidentiality: [{ key: "gering", label: "Gering" }, { key: "mittel", label: "Mittel" }, { key: "hoch", label: "Hoch" }],
    risk_integrity: [{ key: "gering", label: "Gering" }, { key: "hoch", label: "Hoch" }, { key: "mittel", label: "Mittel" }],
    risk_availability: [{ key: "gering", label: "Gering" }, { key: "mittel", label: "Mittel" }, { key: "hoch", label: "Hoch" }],
  ...
  'aufgaben_&_freigaben': {
    task_type: [{ key: "aufgabe", label: "Aufgabe" }, { key: "review", label: "Review" }, { key: "eskalation", label: "Eskalation" }, { key: "erinnerung", label: "Erinnerung" }, { key: "freigabe", label: "Freigabeanfrage" }],
  ...
  'findings_&_abweichungen': {
    finding_type: [{ key: "nc_minor", label: "Nichtkonformität (Minor)" }, { key: "beobachtung", label: "Beobachtung" }, { key: "verbesserung", label: "Verbesserungspotenzial" }, { key: "positiv", label: "Positiver Befund" }, { key: "nc_major", label: "Nichtkonformität (Major)" }],
  ...
  'kontroll_management': {
    ctrl_type: [{ key: "detektiv", label: "Detektiv" }, { key: "korrektiv", label: "Korrektiv" }, { key: "direktiv", label: "Direktiv" }, { key: "praeventiv", label: "Präventiv" }],
  ...
  'awareness_&_schulungen': {
    training_type: [{ key: "awareness", label: "Awareness-Kampagne" }, { key: "technisch", label: "Technische Schulung" }, { key: "fuehrung", label: "Führungskräfteschulung" }, { key: "onboarding", label: "Onboarding" }, { key: "phishing", label: "Phishing-Simulation" }, { key: "pflicht", label: "Pflichtschulung" }, { key: "sonstiges", label: "Sonstiges" }],
...
export type CreateRisikomanagement = StripLookup<Risikomanagement['fields']>;
