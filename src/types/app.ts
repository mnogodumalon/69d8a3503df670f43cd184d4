...
export interface RisikoRegister {
  ...
  fields: {
    ...
    risk_asset?: string; // applookup -> URL zu 'AssetRegister' Record
    risk_org_unit?: string; // applookup -> URL zu 'Organisationseinheiten' Record
...
export const FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  'risiko_register': {
    ...
    'risk_category': 'lookup/select',
    'risk_asset': 'applookup/select',
    'risk_org_unit': 'applookup/select',
