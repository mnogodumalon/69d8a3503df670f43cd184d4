...
export interface IncidentManagement {
  ...
  fields: {
    ...
    incident_affected_asset?: string;
...
export const LOOKUP_OPTIONS: Record<string, Record<string, {key: string, label: string}[]>> = {
  'risikomanagement': {
    ...
    risk_integrity: [{ key: "gering", label: "Gering" }, { key: "mittel", label: "Mittel" }, { key: "hoch", label: "Hoch" }],
  ...
  'soa_management': {
    soa_inclusion_reason: [{ key: "vertraglich", label: "Vertragliche Anforderung" }, { key: "risiko", label: "Ergebnis der Risikobeurteilung" }, { key: "best_practice", label: "Best Practice" }, { key: "gesetzlich", label: "Gesetzliche Anforderung" }, { key: "richtlinie", label: "Unternehmensrichtlinie" }],
  ...
  'audit_management': {
    audit_status: [{ key: "geplant", label: "Geplant" }, { key: "in_durchfuehrung", label: "In Durchführung" }, { key: "abgebrochen", label: "Abgebrochen" }, { key: "abgeschlossen", label: "Abgeschlossen" }],
...
export const FIELD_TYPES: Record<string, Record<string, string>> = {
  ...
  'incident_management': {
    ...
    'incident_affected_asset': 'multipleapplookup/select',
