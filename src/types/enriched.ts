import type { AssetRegister, AuditManagement, AufgabenFreigaben, AwarenessSchulungen, BcmNotfallmanagement, DokumenteEvidenzen, FindingsAbweichungen, IncidentManagement, KontrollManagement, MassnahmenManagement, PolicyManagement, RisikoRegister, SoaManagement } from './app';
...
export type EnrichedRisikoRegister = RisikoRegister & {
