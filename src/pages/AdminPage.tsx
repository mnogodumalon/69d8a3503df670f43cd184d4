...
const RISIKOMANAGEMENT_FIELDS = [
  ...
  { key: 'risk_asset', label: 'Betroffenes Asset', type: 'multipleapplookup/select', targetEntity: 'asset_register', targetAppId: 'ASSET_REGISTER', displayField: 'asset_name' },
  ...
  { key: 'risk_integrity', label: 'Integrität', type: 'lookup/radio', options: [{ key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
...
const SOAMANAGEMENT_FIELDS = [
  ...
  { key: 'soa_inclusion_reason', label: 'Einbeziehungsgrund', type: 'multiplelookup/checkbox', options: [{ key: 'vertraglich', label: 'Vertragliche Anforderung' }, { key: 'risiko', label: 'Ergebnis der Risikobeurteilung' }, { key: 'best_practice', label: 'Best Practice' }, { key: 'gesetzlich', label: 'Gesetzliche Anforderung' }, { key: 'richtlinie', label: 'Unternehmensrichtlinie' }] },
