...
const RISIKOREGISTER_FIELDS = [
  ...
  { key: 'risk_category', label: 'Risikokategorie', type: 'lookup/select', options: [{ key: 'infosec', label: 'Informationssicherheit' }, { key: 'datenschutz', label: 'Datenschutz' }, { key: 'betrieb', label: 'Betriebsrisiko' }, { key: 'compliance', label: 'Compliance' }, { key: 'drittpartei', label: 'Drittpartei / Lieferant' }, { key: 'physisch', label: 'Physische Sicherheit' }, { key: 'personal', label: 'Personalrisiko' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'risk_asset', label: 'Betroffenes Asset', type: 'applookup/select', targetEntity: 'asset_register', targetAppId: 'ASSET_REGISTER', displayField: 'asset_name' },
  { key: 'risk_org_unit', label: 'Betroffene Organisationseinheit', type: 'applookup/select', targetEntity: 'organisationseinheiten', targetAppId: 'ORGANISATIONSEINHEITEN', displayField: 'org_housenumber' },
