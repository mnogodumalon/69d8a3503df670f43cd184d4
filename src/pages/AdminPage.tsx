...
const SOAMANAGEMENT_FIELDS = [
  ...
  { key: 'soa_inclusion_reason', label: 'Einbeziehungsgrund', type: 'multiplelookup/checkbox', options: [{ key: 'gesetzlich', label: 'Gesetzliche Anforderung' }, { key: 'vertraglich', label: 'Vertragliche Anforderung' }, { key: 'risiko', label: 'Ergebnis der Risikobeurteilung' }, { key: 'best_practice', label: 'Best Practice' }, { key: 'richtlinie', label: 'Unternehmensrichtlinie' }] },
...
const RISIKOMANAGEMENT_FIELDS = [
  ...
  { key: 'risk_confidentiality', label: 'Vertraulichkeit', type: 'lookup/radio', options: [{ key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
  { key: 'risk_integrity', label: 'Integrität', type: 'lookup/radio', options: [{ key: 'gering', label: 'Gering' }, { key: 'hoch', label: 'Hoch' }, { key: 'mittel', label: 'Mittel' }] },
  { key: 'risk_availability', label: 'Verfügbarkeit', type: 'lookup/radio', options: [{ key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
...
const AUFGABENFREIGABEN_FIELDS = [
  ...
  { key: 'task_type', label: 'Aufgabentyp', type: 'lookup/select', options: [{ key: 'aufgabe', label: 'Aufgabe' }, { key: 'review', label: 'Review' }, { key: 'eskalation', label: 'Eskalation' }, { key: 'erinnerung', label: 'Erinnerung' }, { key: 'freigabe', label: 'Freigabeanfrage' }] },
  ...
  { key: 'task_related_risk', label: 'Zugehöriges Risiko', type: 'applookup/select', targetEntity: 'risikomanagement', targetAppId: 'RISIKOMANAGEMENT', displayField: 'risk_title' },
...
const MASSNAHMENMANAGEMENT_FIELDS = [
  ...
  { key: 'measure_risk', label: 'Zugehöriges Risiko', type: 'applookup/select', targetEntity: 'risikomanagement', targetAppId: 'RISIKOMANAGEMENT', displayField: 'risk_title' },
...
const FINDINGSABWEICHUNGEN_FIELDS = [
  ...
  { key: 'finding_type', label: 'Finding-Typ', type: 'lookup/select', options: [{ key: 'nc_minor', label: 'Nichtkonformität (Minor)' }, { key: 'beobachtung', label: 'Beobachtung' }, { key: 'verbesserung', label: 'Verbesserungspotenzial' }, { key: 'positiv', label: 'Positiver Befund' }, { key: 'nc_major', label: 'Nichtkonformität (Major)' }] },
...
const KONTROLLMANAGEMENT_FIELDS = [
  ...
  { key: 'ctrl_type', label: 'Kontrolltyp', type: 'lookup/select', options: [{ key: 'detektiv', label: 'Detektiv' }, { key: 'korrektiv', label: 'Korrektiv' }, { key: 'direktiv', label: 'Direktiv' }, { key: 'praeventiv', label: 'Präventiv' }] },
...
const AWARENESSSCHULUNGEN_FIELDS = [
  ...
  { key: 'training_type', label: 'Schulungstyp', type: 'lookup/select', options: [{ key: 'awareness', label: 'Awareness-Kampagne' }, { key: 'technisch', label: 'Technische Schulung' }, { key: 'fuehrung', label: 'Führungskräfteschulung' }, { key: 'onboarding', label: 'Onboarding' }, { key: 'phishing', label: 'Phishing-Simulation' }, { key: 'pflicht', label: 'Pflichtschulung' }, { key: 'sonstiges', label: 'Sonstiges' }] },
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('bcm_&_notfallmanagement');
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'risikomanagement' && fieldKey === 'risk_org_unit') {
      const match = (lists.organisationseinheitenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.org_housenumber ?? '—';
    }
    ...
    if (entity === 'aufgaben_&_freigaben' && fieldKey === 'task_related_risk') {
      ...
      return match?.fields.risk_title ?? '—';
    }
