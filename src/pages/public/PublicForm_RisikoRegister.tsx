...
async function submitPublicForm(fields: Record<string, unknown>) {
  const res = await fetch(`${KLAR_BASE}/public/69d8a3503df670f43cd184d4/69d8a2cdd093755ffa3afc64/submit`, {
    method: 'POST',
...
export default function PublicFormRisikoRegister() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Risiko-Register — Formular</h1>
        </div>
