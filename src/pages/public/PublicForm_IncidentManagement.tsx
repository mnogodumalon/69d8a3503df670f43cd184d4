...
const PROXY_BASE = '';
const APP_ID = '69d8a2d45f729875c036a830';
      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="incident_affected_asset"
              value={fields.incident_affected_asset ?? ''}
              onChange={e => setFields(f => ({ ...f, incident_affected_asset: e.target.value }))}
