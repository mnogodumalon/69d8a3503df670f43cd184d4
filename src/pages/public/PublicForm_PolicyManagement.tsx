...
async function submitPublicForm(fields: Record<string, unknown>) {
  const res = await fetch(`${KLAR_BASE}/public/69d8a3503df670f43cd184d4/69d8a2d7cc4d6bfd1a9a28df/submit`, {
    method: 'POST',
...
export default function PublicFormPolicyManagement() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Policy-Management — Formular</h1>
        </div>
