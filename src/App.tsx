...
import PublicFormRisikoRegister from '@/pages/public/PublicForm_RisikoRegister';
      ...
      <HashRouter>
        <ActionsProvider>
          <Routes>
            ...
            <Route path="public/69d8a2cdd093755ffa3afc64" element={<PublicFormRisikoRegister />} />
