...
export function MassnahmenManagementViewDialog({ open, onClose, record, onEdit, risikomanagementList }: MassnahmenManagementViewDialogProps) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{getRisikomanagementDisplayName(record.fields.measure_risk)}</p>
          </div>
          <div className="space-y-1">
