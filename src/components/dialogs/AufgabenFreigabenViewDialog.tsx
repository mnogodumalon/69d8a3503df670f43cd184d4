...
export function AufgabenFreigabenViewDialog({ open, onClose, record, onEdit, risiko_registerList, maßnahmen_managementList, audit_managementList }: AufgabenFreigabenViewDialogProps) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">{getRisikoRegisterDisplayName(record.fields.task_related_risk)}</p>
          </div>
          <div className="space-y-1">
